...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/24 17:19:02 by druiz-ca          #+#    #+#             */
/*   Updated: 2023/09/24 17:26:27 by druiz-ca         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((cont_x == 1 && cont_y == 1) || (cont_y == 1 && cont_x == x && x > 1))
		ft_putchar('A');
	...
	if ((cont_y > 1 && cont_y < y && cont_x == x) || (cont_y > 1 && cont_y < y
			&& cont_x == 1))
		ft_putchar('B');
	if ((cont_x == x && cont_y == y && x > 1 && y != 1) || (cont_x == 1
			&& cont_y == y && y > 1))
		ft_putchar('C');
