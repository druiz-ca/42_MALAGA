...
/*   Updated: 2025/03/30 11:45:24 by druiz-ca         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm *PresidentialPardonForm::makeForm(AForm *document, const string &name, const string &target)
{
    if (document == NULL && name == "presidential pardon")
        return (new PresidentialPardonForm(target));
    // se tiene que crear el objeto con new(en el heap) pq sino al salir del
    // bloque se destruiría automáticamente el objeto
    return (document);
}