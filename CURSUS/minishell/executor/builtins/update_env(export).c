...
/*   Updated: 2024/10/10 17:10:28 by druiz-ca         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_print_env_err(t_shell *shell, int env_err, char *command)
{
    int i;
...
void ft_update_env_main(t_shell *shell, char **commands)
{
    int i;
